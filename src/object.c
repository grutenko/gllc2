...
static struct gllc_prop props[] = {P_STRING_RO(LC_PROP_G_REGCODE, _g_regcode_GET),
...
static struct gllc_object_vtable vtable = {.destroy = destroy};
struct g_props_object G_props_object = {
    ._obj = {.magic = GLLC_OBJMAGIC, .props = all_props, .vtable = &vtable}, .version = "1.0.0", .dirdll = "."};
