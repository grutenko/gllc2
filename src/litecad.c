...
#error "GLLC Library: Unsupported platform. Only Windows, Emscripten, and Linux (X11/Wayland/GTK) are supported."
        ...
        {
                FMTERROR("use XlcCreateWindowX11() for X11_backend");
                return NULL;
        }
        else
        {
                FMTERROR("Not selected backend. Use XLC_WINDOW_*_BACKEND.");
                return NULL;
        }
#endif
}
...
LCAPI int lcQuadSet(void *hQuad, double x0, double y0, double x1, double y1, double x2, double y2, double x3, double y3)
{
        return 0;
}
LCAPI int lcQuadTransXYtoUV(void *hQuad, double X, double Y, double *pU, double *pV)
{
        return 0;
}
LCAPI int lcQuadTransUVtoXY(void *hQuad, double U, double V, double *pX, double *pY)
{
        return 0;
}
...
LCAPI int lcGridSet(void *hGrid, double X0, double Y0, double W, double H, int Nx, int Ny)
{
        return 0;
}
...
LCAPI int lcGridTrans(void *hGrid, double X, double Y, double *pXdest, double *pYdest)
{
        return 0;
}
LCAPI int lcGridGetNode(void *hGrid, int bDest, int Ix, int Iy, double *pX, double *pY)
{
        return 0;
}
...
LCAPI int lcGridSetView(void *hGrid, int Mode, void *hLcWnd, int ColLine, int ColNode)
{
        return 0;
} // Mode: 0-disable, 1-original, 2-destination

// Command Window
LCAPI void *lcCreateCmdwin(void *hWndParent, int Left, int Top, int Width, int Height)
{
        return NULL;
}
LCAPI int lcCmdwinResize(void *hCmdLine, int Left, int Top, int Width, int Height)
{
        return 0;
}
LCAPI int lcCmdwinUpdate(void *hCmdLine)
{
        return 0;
} // undoc
...
LCAPI int lcPropsResize(void *hPropWnd, int Left, int Top, int Width, int Height)
{
        return 0;
}
...
// Status Bar
LCAPI void *lcCreateStatbar(void *hWndParent)
{
        return NULL;
} // also LC_PROP_SBAR_H and others
LCAPI int lcDeleteStatbar(void *hStatbar)
{
        return 0;
}
LCAPI int lcStatbarResize(void *hStatbar, int Left, int Top, int Width, int Height)
{
        return 0;
}
...
// utility functions
LCAPI int lcDgGetValue(void *hWnd, int Lef, int Top, char *szTitle, char *szPrompt)
{
        return 0;
}
...
LCAPI int lcCameraConnect(char *szName)
{
        return 0;
...
LCAPI int lcDrwDeleteUnused(void *hDrw, int ObjType)
{
        return 0;
} // undoc
...
LCAPI int lcPlineMakeArrow(void *hPline, double Hline, double Harr)
{
        return 0;
} // undoc
LCAPI void *lcPlineSplitBySI(void *hPline, int bSelect, int bErase)
{
        return NULL;
} // undoc
...
LCAPI int lcTIN_Triangulate(void *hTIN, void *hLcWnd)
{
        return 0;
} // LC_CMD_TIN_BNDTRANG
...
LCAPI int lcImageLoadDIB(void *hImage, void *hDib2)
{
        return 0;
} // undoc
